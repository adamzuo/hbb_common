...
lazy_static::lazy_static! {
    pub static ref ORG: RwLock<String> = RwLock::new("cn.com.citygroup".to_owned());
}
...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("CTG远程控制".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["121.33.75.98"];
pub const RS_PUB_KEY: &str = "xRj64mVIGfr8jMPa5VaWgqKjSd7w8HYyys7I9nYO0TE=";
